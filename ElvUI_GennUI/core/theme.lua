...
if theme == "dark" then
	...
	E.db["unitframe"]["units"]["raid1"]["name"]["text_format"] = "[namecolor][name:short]"
	E.db["unitframe"]["units"]["raid2"]["name"]["text_format"] = "[namecolor][name:short]"
	E.db["unitframe"]["units"]["raid3"]["name"]["text_format"] = "[namecolor][name:short]"
