...
E.db["WT"]["combat"]["covenantHelper"]["enable"] = false
...
E.db["WT"]["item"]["extraItemsBar"]["bar1"]["include"] = "QUEST,UTILITY,OPENABLE"
...
E.db["WT"]["item"]["extraItemsBar"]["bar2"]["include"] = "POTIONDF,FLASKDF,FOODDF,FOODVENDOR,MAGEFOOD"
